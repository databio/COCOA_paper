...
pcAnnoScoreDist 
ggsave(filename = ffPlot(paste0(plotSubdir, "pc1AnnoScoreDistERRelated.stvg")), 
...
atacCor = cor(x = signalMat, y = pcScore)
...
rsScoreHeatmap(rsScores, signalCol=paste0("PC", 1:4), rsNameCol = "rsName", 
               orderByCol = "PC1", 
